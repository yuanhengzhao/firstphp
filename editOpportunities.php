...
$(function() {
  $("#close_button").ctrck(function(e){
    confirm("Do you want to close your opportunity?");
  })
});
</script>
  </head>
                        ...
                        <h2>Edit <?php echo $row['Business_Name'];?></h2>
                            <form class="form-horizontal" role="form" action="editOpportunities.php?new=<?php echo $_GET['new']?>" method="POST">
                                ...
                                <div class="radio" id="choice" style="margin-left:20px">
                                    ...
                                    <label><input type="radio" name="bi[status]" id="close_button"] value="Closed" <?php if ($row['status']== 'closed') echo 'checked'?> " >Closed</label>
                                </div>
                                </div>
                                <div class="form-group">
